...
class InceptionResnetV2(nn.Module):
    def __init__(self, input_size, denoise_block, fwd_out, num_fwd, back_out, num_back, shrink, noise,
                 num_classes=1001):
        ...
        h_in, w_in = [299, 71, 35, 17, 8], [299, 71, 35, 17, 8]
        denoise = []
        n_in = [3, 192, 320, 1088, 1536]
        block = denoise_block
    ...
    def forward(self, x, defense=False):
        ...
        if defense:
            x = self.shrink * self.denoise[0](x)
...
class Net(nn.Module):
    def __init__(self, input_size, block, fwd_out, num_fwd, back_out, num_back, n, shrink, noise, hard_mining=0,
        ...
        self.net = InceptionResnetV2(input_size, block, fwd_out, num_fwd, back_out, num_back, shrink, noise)
